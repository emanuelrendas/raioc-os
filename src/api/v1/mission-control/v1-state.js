    ...
    return {
      ...
      body: {
        ...
        systemClock: {
          ...
          dxbTime: new Date().toLocaleTimeString('en-US', { timeZone: 'Asia/Dubai' }),
          lonTime: new Date().toLocaleTimeString('en-US', { timeZone: 'Europe/London' }),
          lisTime: new Date().toLocaleTimeString('en-US', { timeZone: 'Europe/Lisbon' }),
          nycTime: new Date().toLocaleTimeString('en-US', { timeZone: 'America/New_York' }),
        },

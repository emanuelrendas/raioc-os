...
<body class="min-h-screen antialiased selection:bg-brand-500 selection:text-black">
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
    ...
    <!-- SECTION 3: Golden Visa Legal Stamp (Cabinet Res. 65/2022) -->
    <section class="glass-card rounded-3xl p-8 md:p-10 border-2 border-gold-500/30 relative overflow-hidden gold-badge-glow bg-gradient-to-br from-gold-950/30 via-surface-card to-surface-canvas">
      <div class="flex flex-col md:flex-row items-center gap-8 justify-between">
        <div class="flex items-center space-x-6">
          <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-gold-400 to-gold-700 p-0.5 shadow-xl shadow-gold-500/20 flex-shrink-0">
            <div class="w-full h-full bg-slate-950 rounded-[14px] flex flex-col items-center justify-center p-2 text-center">
              <svg class="w-8 h-8 text-gold-400 mb-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 1.944A11.954 11.954 0 012.166 5C2.056 5.649 2 6.319 2 7c0 5.225 3.34 9.67 8 11.317C14.66 16.67 18 12.225 18 7c0-.682-.057-1.35-.166-2.001A11.954 11.954 0 0110 1.944zM11 14a1 1 0 11-2 0 1 1 0 012 0zm0-7a1 1 0 10-2 0v3a1 1 0 102 0V7z" clip-rule="evenodd"/></svg>
              <span class="text-[8px] font-mono font-extrabold text-gold-400 uppercase tracking-tighter">GOLDEN VISA</span>
            </div>
          </div>
          <div class="space-y-1">
            ...
            <p class="text-slate-300 text-sm max-w-xl">
              Qualifies for the 10-Year Renewable Real Estate Investor Golden Visa. Unlocks 100% foreign business ownership, zero personal and corporate capital gains taxes, and unrestricted family sponsorship.
            </p>
          </div>
        </div>

        <div class="flex-shrink-0 text-center md:text-right">
          <div class="px-6 py-3 rounded-2xl bg-gold-500/10 border border-gold-500/40 text-gold-300 font-mono font-bold text-sm tracking-wide">
            10-YEAR SOVEREIGN RESIDENCY
          </div>
          <span class="text-[11px] text-slate-400 block mt-2">Executive Regulations of Federal Decree-Law No. 29/2021</span>
        </div>
      </div>
    </section>

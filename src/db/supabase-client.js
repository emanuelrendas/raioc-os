...
export class SupabaseClient {
  ...
  initEnterpriseCoreSeeds() {
    ...
    const initialAgents = [
      ...
      {
        id: 'hermes_crm_pipeline',
        name: 'HERMES',
        role: 'CRM & Pipeline Management Specialist',
        model: 'gemini-2.5-flash',
        capabilities: ['crm_sync', 'pipeline_automation', 'investor_records', 'lifecycle_tracking'],
        permissions: ['read:crm', 'write:crm', 'sync:leads'],
        cost_budget: { monthly_limit_usd: 450, current_spend_usd: 11.2, currency: 'USD' },
        version: '2.0.0',
        owner: 'CTO',
        status: 'ACTIVE',
        created_at: new Date().toISOString(),
      ...
      {
        id: 'helios_calendar_scheduler',
        name: 'HELIOS',
        role: 'Advisory Calendar & Scheduling Specialist',
        model: 'gemini-2.5-flash',
        capabilities: ['calendar_booking', 'timezone_conversion', 'slot_management', 'advisory_dispatch'],
        permissions: ['read:calendar', 'write:calendar', 'schedule:meetings'],
        cost_budget: { monthly_limit_usd: 400, current_spend_usd: 9.5, currency: 'USD' },
        version: '2.0.0',
        owner: 'CTO',
        status: 'ACTIVE',
        created_at: new Date().toISOString(),
      ...
      {
        id: 'brand_content_theses',
        name: 'BRAND',
        role: 'Institutional Content Strategy & Brand Specialist',
        model: 'gemini-2.5-flash',
        capabilities: ['content_strategy', 'thesis_generation', 'market_reports', 'editorial_review'],
        permissions: ['generate:content', 'publish:articles', 'read:theses'],
        cost_budget: { monthly_limit_usd: 500, current_spend_usd: 14.3, currency: 'USD' },
        version: '2.0.0',
        owner: 'CTO',
        status: 'ACTIVE',
        created_at: new Date().toISOString(),
      ...
      {
        id: 'engage_social_compliance',
        name: 'ENGAGE',
        role: 'Social Engagement & Statutory Compliance Watchdog',
        model: 'gemini-2.5-flash',
        capabilities: ['social_moderation', 'compliance_filtering', 'sentiment_analysis', 'audit_recording'],
        permissions: ['read:social', 'moderate:comments', 'flag:violations'],
        cost_budget: { monthly_limit_usd: 450, current_spend_usd: 10.1, currency: 'USD' },
        version: '2.0.0',
        owner: 'CTO',
        status: 'ACTIVE',
        created_at: new Date().toISOString(),
      ...
      {
        id: 'dm_conversion_inbound',
        name: 'DM_CONVERSION',
        role: 'Inbound Direct Message Conversion Specialist',
        model: 'gemini-2.5-flash',
        capabilities: ['inbound_dm_triage', 'lead_qualification', 'whatsapp_flow', 'vip_conversion'],
        permissions: ['read:messages', 'send:messages', 'qualify:leads'],
        cost_budget: { monthly_limit_usd: 600, current_spend_usd: 16.7, currency: 'USD' },
        version: '2.0.0',
        owner: 'CTO',
        status: 'ACTIVE',
        created_at: new Date().toISOString(),
      ...
      {
        id: 'social_analytics_telemetry',
        name: 'SOCIAL_ANALYTICS',
        role: 'Social Growth & Telemetry Mesh Specialist',
        model: 'gemini-2.5-flash',
        capabilities: ['growth_tracking', 'engagement_metrics', 'audience_insights', 'telemetry_mesh'],
        permissions: ['read:analytics', 'generate:metrics', 'export:telemetry'],
        cost_budget: { monthly_limit_usd: 400, current_spend_usd: 7.8, currency: 'USD' },
        version: '2.0.0',
        owner: 'CTO',
        status: 'ACTIVE',
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        name: 'AIDA',
        role: 'Client Relations & Voice AI Specialist',
        model: 'gemini-2.5-flash',
        capabilities: ['flow_teaser_generation', 'mixboard_composition', 'whatsapp_dispatch', 'voice_synthesis'],
        permissions: ['dispatch:brief', 'generate:media', 'send:whatsapp', 'synthesize:voice'],

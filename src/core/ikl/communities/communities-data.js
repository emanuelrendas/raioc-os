...
export const communitiesData = [
  ...
  {
    id: 'comm_palm_jebel_ali',
    name: 'Palm Jebel Ali',
    type: 'Ultra-Luxury Waterfront Mega-Fronds',
    avgGrossYield: 6.5,
    avgNetYield: 5.2,
    capitalAppreciationTier: 'EXPONENTIAL',
    pricePerSqFtAed: 3200,
    infrastructureStatus: 'MEGA_DEVELOPMENT_ACTIVE',
    keyLandmarks: ['Fronds Collection', 'Crown Mansions', 'Nakheel Master Marina'],
    targetPersonas: ['SOVEREIGN_WEALTH_ALLOCATOR', 'HIGH_NET_WORTH_INSTITUTIONAL'],
    provenance: {
      source: 'Nakheel Official Masterplan / DLD Registry',
      citation: 'Dubai 2040 Urban Master Plan & DLD Fronds Registry 2026',
      authorityWeight: AuthorityLevel.STATUTORY,
      lastVerified: '2026-08-01T00:00:00.000Z',
    },
  },
  {
    id: 'comm_dubai_islands',
    name: 'Dubai Islands',
    type: 'Emerging Prime Coastal Archipelago',
    avgGrossYield: 7.4,
    avgNetYield: 6.1,
    capitalAppreciationTier: 'VERY_HIGH',
    pricePerSqFtAed: 2400,
    infrastructureStatus: 'GROWTH_ACTIVE',
    keyLandmarks: ['Island Marina', 'Deira Coastal Gateway', 'Luxury Resort Strip'],
    targetPersonas: ['YIELD_FOCUSED_PORTFOLIO', 'CAPITAL_APPRECIATION_MAXIMIZER'],
    provenance: {
      source: 'Nakheel & DLD Data Hub',
      citation: 'Dubai Islands Statutory Masterplan 2026',
      authorityWeight: AuthorityLevel.STATUTORY,
      lastVerified: '2026-08-01T00:00:00.000Z',
    },
  },

...
const AREAS = {
  ...
  bay:      {n:"Jumeirah Bay Island", b:"AED 28M — 220M+", psf:3400, yl:4.0, gr:4, rk:1, band:"o20", st:"ready", net_n:2.9, sc:38, ab:0.18, pres:5, liq:"Thin",
             d:"The seahorse island. Bulgari-anchored ultra-prime sanctuary where minimum entry transactions (Bulgari Residences) start at AED 28M+, severely limited inventory, and one of the strongest price trajectories in the region.",
             c:"Ultra-prime · island", y:"Collectors of assets", r:"Appreciation-led", net:"3 — 5%"},
  hills2:   {n:"Emirates Hills", b:"AED 45M — 250M+", psf:2400, yl:4.0, gr:3, rk:1, band:"o20", st:"ready", net_n:3.1, sc:22, ab:0.12, pres:5, liq:"Thin",
             d:"Dubai's original Beverly Hills gated enclave with prime renovated mansions and plots transacting at AED 45M+. Mature landscaping, absolute privacy, and a resident register that reads like a market index.",
  ...
  difc:     {n:"DIFC", b:"AED 2.2M — 25M+", psf:2200, yl:7.0, gr:3, rk:2, band:"u2", st:"ready", net_n:5.3, sc:26, ab:0.55, pres:4, liq:"Moderate",
  ...
  saadiyat: {n:"Saadiyat Island · Abu Dhabi", b:"AED 3.0M — 70M+", psf:2300, yl:5.0, gr:5, rk:2, band:"2to8", st:"both", net_n:3.6, sc:20, ab:0.58, pres:5, liq:"Moderate",
  ...
  marjan:   {n:"Al Marjan Island · RAK", b:"AED 1.4M — 18M+", psf:1452, yl:6.2, gr:4, rk:5, band:"u2", st:"offplan", net_n:4.6, sc:12, ab:2.1, pres:2, liq:"Thin",
             d:"Post-gaming license pricing dynamics for Wynn corridor residences. Wynn Al Marjan, the UAE's first licensed casino resort, opens 2027. Much of the catalyst is already priced in. Gross yields around 5.5–7%.",
